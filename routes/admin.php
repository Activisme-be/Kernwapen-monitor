...
Route::get('/artikelen/publiceer/{article}', [BackendController::class, 'publish'])->name('article.publish');
Route::get('/artikelen/draft/{article}', [BackendController::class, 'unpublish'])->name('article.draft');
